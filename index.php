        ...
        <div class="max-w-md mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <form id="orderForm" class="space-y-4" data-aos="fade-up">
                ...
                <div>
                    ...
                    <input type="email" id="customerEmail" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-pink-500 focus:ring-pink-500">
                </div>
    ...
    <script>
        ...
        form.addEventListener('submit', async (e) => {
            ...
            const formData = {
                ...
                deliveryMethod: document.querySelector('.delivery-option.border-pink-500')?.dataset.method || '',
                phoneModel: document.getElementById('phoneModel').value
            };

            // Validate required fields
            if (!formData.deliveryMethod) {
                throw new Error('Prašome pasirinkti pristatymo būdą');
            }
